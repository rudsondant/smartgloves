...
public class Menu : MonoBehaviour {
	...
	void OnGUI(){
		...
		bool manual = GUI.Button(new Rect (Screen.width-900, Screen.height-250,100,130), rk);
		...
		if (play) {
			...
			PlayerPrefs.SetInt("esquerda", 0);
			PlayerPrefs.SetInt("direita", 0);
